 ...
 */
class CompanyBusinessUnitCompanyUnitAddressMapperPlugin extends AbstractPlugin implements CompanyUnitAddressMapperPluginInterface
{
    /**
     * Specification:
    ...
    public function map(
        ...
        return $this->getFacade()->mapCompanyBusinessUnitToCompanyUnitAddress(
