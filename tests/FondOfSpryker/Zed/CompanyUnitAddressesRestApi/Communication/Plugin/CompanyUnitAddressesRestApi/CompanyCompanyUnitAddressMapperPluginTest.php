...
class CompanyCompanyUnitAddressMapperPluginTest extends Unit
{
    /**
     * @var \FondOfSpryker\Zed\CompanyUnitAddressesRestApi\Communication\Plugin\CompanyUnitAddressesRestApi\CompanyCompanyUnitAddressMapperPlugin
     */
    protected $companyCompanyUnitAddressMapperPlugin;
    ...
    protected function _before(): void
    {
        ...
        $this->companyCompanyUnitAddressMapperPlugin = new CompanyCompanyUnitAddressMapperPlugin();
        $this->companyCompanyUnitAddressMapperPlugin->setFacade($this->companyUnitAddressesRestApiFacadeMock);
    }
    ...
    public function testMap(): void
    {
        ...
        $this->assertInstanceOf(
            ...
            $this->companyCompanyUnitAddressMapperPlugin->map(
                $this->restCompanyUnitAddressesRequestAttributesTransferMock,
                $this->companyUnitAddressTransferMock
            )
        );
